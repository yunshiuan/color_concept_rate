...
jsPsych.plugins['survey-multi-selectMAS'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'survey-multi-selectMAS',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-select-question { margin-top: 1em; margin-bottom: 2em; text-align: left; font-size: 18px; line-height: 1.2em; }"+
      ...
      ".jspsych-survey-multi-select-option { line-height: 1; }"+
      ".jspsych-survey-multi-select-horizontal .jspsych-survey-multi-select-option {  display: inline-block;  margin-left: 2em;  margin-right:2em;  vertical-align: top;}"+
